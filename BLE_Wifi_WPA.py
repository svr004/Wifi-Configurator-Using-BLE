...
class RxCharacteristic(Characteristic):
    ...
    def connect(self,goal_ssid,goal_pw):
        goal_ssid = '"' + goal_ssid + '"'  
        goal_pw = '"' + goal_pw + '"'
        cm = "sudo sed -i '6s/.*/        ssid=" + goal_ssid + "/' /etc/wpa_supplicant/wpa_supplicant.conf"
        os.system(cm)
        cm = "sudo sed -i '7s/.*/        psk=" + goal_pw + "/' /etc/wpa_supplicant/wpa_supplicant.conf"
        os.system(cm)
